...
import { exportToExcel, exportToWord, exportToPPT, exportToCSV } from '@/lib/exportUtils';
...
export default function Dashboard() {
    ...
    const handleSmartDownload = async (e: React.MouseEvent, dataset: any) => {
        e.stopPropagation();
        const headers = dataset.headers || [];
        const rows = dataset.rows || [];
        const filename = dataset.name || 'dataset';
        const mode = dataset.metadata?.process_mode || 'excel';
        ...
        <div className="space-y-8 font-sans animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-linear-to-br from-indigo-600 to-purple-600 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
